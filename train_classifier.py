...
def main(config):
    svname = args.name
    if svname is None:
        svname = 'classifier_{}'.format(config['train_dataset']) # new_crop_color
    ...
    utils.log('train dataset: {} (x{}), {}'.format(
        ...
        train_dataset.n_classes), filename='{}_pretrain.txt'.format(config['train_dataset']))
    ...
    if config.get('val_dataset'):
        ...
        utils.log('val dataset: {} (x{}), {}'.format(
            ...
            val_dataset.n_classes), filename='{}_pretrain.txt'.format(config['train_dataset']))
        if config.get('visualize_datasets'):
    ...
    if config.get('fs_dataset'):
        ...
        utils.log('fs dataset: {} (x{}), {}'.format(
            ...
            fs_dataset.n_classes), filename='{}_pretrain.txt'.format(config['train_dataset']))
        if config.get('visualize_datasets'):
    ...
    utils.log('num params: {}'.format(utils.compute_n_params(model)),
              filename='{}_pretrain.txt'.format(config['train_dataset']))
    ...
    for epoch in range(1, max_epoch + 1 + 1):
        ...
        utils.log(log_str, filename='{}_pretrain.txt'.format(config['train_dataset']))
